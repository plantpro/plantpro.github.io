...
(function () {
  ...
  var checkedof, countIt, delws, div, ejoin, element, first, htmlset, keys, last, makeKeyCells, makeMapCells, makeValueCells, max, maxKey, maxValue, min, mul, startSearch, sub, sum, valueof, values, valueset;
