...
(function () {
  document.flexibel = function () {
    var checkedof, del, delws, div, ejoin, element, first, htmlset, last, map, _max, _min, _mul, sub, _sum, valueof, valueset; // Operator function for '-'
    ...
    map = function () {
      var countIt, keys, makeKeyCells, makeValueCells, maxKey, maxValue, values;
