...
(function () {
  ...
  var checkedof, countIt, del, delws, div, ejoin, element, first, htmlset, keys, last, makeKeyCells, makeValueCells, _max, maxKey, maxValue, _min, _mul, sub, _sum, valueof, values, valueset;
