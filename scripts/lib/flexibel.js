...
(function () {
  ...
  var checkedof, countIt, delws, div, ejoin, element, first, htmlset, keys, last, makeKeyCells, makeValueCells, max, maxKey, maxValue, min, mul, sub, sum, valueof, values, valueset;
