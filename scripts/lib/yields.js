...
(function() {
  ...
  */
  var all, any, checkedof, clearError, countIt, delws, div, ejoin, element, evalPotentialYield, fail, first, h1, h2, h3, h4, h5, h6, htmlget, htmlset, keys, last, makeKeyCells, makeMapCells, makeValueCells, max, maxKey, maxValue, min, mul, neue, neueText, runApplication, runParser, sub, sum, unique, valueof, values, valueset,
    indexOf = [].indexOf;
