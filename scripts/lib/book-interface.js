...
(function() {
  var CONTENT_LIST, GOLDEN_RATIO, appendDivision, appendDivisionHeader, buildContentList, cahce, colorize, createContentItem, enableDarkTheme, enableLightTheme, fontSizeChanged, getColor, hideContentList, hideSourceList, hsvToRgb, item, showOrHideContentList, showOrHideSourceList, themeChanged;
  ...
  $("#settings-font-size").change(fontSizeChanged);
