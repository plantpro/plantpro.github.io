...
(function() {
  var CONTENT_LIST, GOLDEN_RATIO, appendDivision, appendDivisionHeader, buildContentList, cahce, colorize, createContentItem, enableDarkTheme, enableLightTheme, getColor, hideContentList, hideSourceList, hsvToRgb, item, showOrHideContentList, showOrHideSourceList, themeChanged;
  ...
  buildContentList = function() {
    ...
    $("#content-list").append($("<div class='nav-panel-title'>Содержание</div>"));
    results = [];
