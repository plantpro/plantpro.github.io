...
(function () {
  ...
  converter = function converter(name, toBase, fromBase) {
    return {
      name: name,
      toBase: toBase,
      fromBase: fromBase
  ...
  weightGroup = [converter("мкг", function (x) {
    return x * Math.pow(10, 6);
  }, function (x) {
    return x / Math.pow(10, 6);
  }), converter("мг", function (x) {
    return x * Math.pow(10, 3);
  }, function (x) {
    return x / Math.pow(10, 3);
  }), converter("г", function (x) {
    return x;
  }, function (x) {
    return x;
  }), converter("кг", function (x) {
    return x * 1000;
  }, function (x) {
    return x / 1000;
  })];
