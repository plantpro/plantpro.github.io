...
(function () {
  var availableFileTypes, checkRecordForFilters, createRegExpFromSearchText, isSatisfiedToAllFilters, isSatisfiedToAutorFilter, isSatisfiedToFileTypeFilter, isSatisfiedToLanguageFilter, isSatisfiedToSearch, makeFilterPanel, makeFilterPanelWithColor, parseFileType, predicates, searchInputClear, showRecordIfSatisfiedToAllFilters, stateChanged, updateResults, updateSearchText;
  availableFileTypes = {
    PDF: {
      name: ".pdf",
