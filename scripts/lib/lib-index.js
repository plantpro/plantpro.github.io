...
(function () {
  var availableFileTypes, clearFilter, isArticle, isSatisfiedToAllPredicates, isSatisfiedToArticleFilter, isSatisfiedToAutorFilter, isSatisfiedToFileTypeFilter, makeFilterPanel, makeFilterPanelWithColor, parseFileType, predicates, stateChanged, updateResults;
  availableFileTypes = {
    PDF: {
      name: ".pdf",
  ...
  isSatisfiedToAutorFilter = function isSatisfiedToAutorFilter(record) {
    return record.children.some(function (elem) {
      return elem.className === "plpro-lib-record-autor" && elem.innerText === text;
    });
  };
