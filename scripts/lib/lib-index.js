...
(function () {
  var availableFileTypes, checkRecordForFilters, isSatisfiedToAllFilters, isSatisfiedToAutorFilter, isSatisfiedToFileTypeFilter, isSatisfiedToSearch, makeFilterPanel, makeFilterPanelWithColor, parseFileType, predicates, searchInputClear, showRecordIfSatisfiedToAllFilters, stateChanged, updateResults, updateSearchText;
  availableFileTypes = {
    PDF: {
      name: ".pdf",
