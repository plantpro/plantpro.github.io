...
(function () {
  var availableFileTypes, doSearch, isArticle, isSatisfiedToAllPredicates, isSatisfiedToArticleFilter, isSatisfiedToAutorFilter, isSatisfiedToFileTypeFilter, isSatisfiedToSearch, makeFilterPanel, makeFilterPanelWithColor, parseFileType, predicates, searchInputClear, stateChanged, updateResults, updateSearchText;
  availableFileTypes = {
    PDF: {
      name: ".pdf",
