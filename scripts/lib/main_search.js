...
(function () {
  ...
  var all, any, checkedof, child, countIt, delws, div, ejoin, elem, element, first, htmlget, htmlset, j, keys, l, last, len, len1, makeKeyCells, makeMapCells, makeValueCells, matchContent, max, maxKey, maxValue, min, mul, ref, ref1, searchTag, startSearch, sub, sum, valueof, values, valueset;
