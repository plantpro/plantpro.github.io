...
(function () {
  ...
  var all, any, checkedof, child, countIt, delws, div, ejoin, elem, element, first, h1, h2, h3, h4, h5, h6, htmlget, htmlset, j, keys, l, last, len, len1, makeKeyCells, makeMapCells, makeValueCells, matchContent, max, maxKey, maxValue, min, mul, neue, neueText, ref, ref1, searchTag, startSearch, sub, sum, unique, valueof, values, valueset;
  ...
  matchContent = function matchContent(element, input) {
  ...
  searchTag = function searchTag(name) {
