...
(function() {
  ...
  */
  var all, any, button, checkedof, countIt, delws, div, ejoin, element, first, h1, h2, h3, h4, h5, h6, htmlget, htmlset, keys, last, makeKeyCells, makeMapCells, makeValueCells, max, maxKey, maxValue, min, mul, neue, neueText, provider, runParser, showSources, sub, sum, unique, valueof, values, valueset,
    indexOf = [].indexOf;
