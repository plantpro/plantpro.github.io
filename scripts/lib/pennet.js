...
function () {
  ...
  _createClass(Counter, [{
    ...
    value: function count(element) {
      return _flexibel.map.countIt(this.counter, element);
    }
  }, {
    key: "getSize",
    ...
    value: function getTable(tableName) {
      var builder;
      return builder = "<label class=\"tblbl\">".concat(tableName, ": </label><br>\n<table class=\"mdl-data-table mdl-js-data-table\">\n\t<tr>").concat((0, _flexibel.ejoin)(_flexibel.map.makeKeyCells(this.counter)), "</tr>\n\t<tr>").concat((0, _flexibel.ejoin)(_flexibel.map.makeValueCells(this.counter)), "</tr>\n</table>");
    }
  }]);
...
runApplication = function runApplication() {
  ...
  clearError();
  genotype1 = (0, _flexibel.valueof)("genotype1").trim();
  genotype2 = (0, _flexibel.valueof)("genotype2").trim();
  ...
  return (0, _flexibel.htmlset)("tableplace", createOutput(gametesFirst, gametesSecond));
};

fail = function fail(error) {
  (0, _flexibel.htmlset)("errorlogs", "<p style=\"color: red;\">".concat(error, "</p>"));
  return false;
};
...
evalPhenotype = function evalPhenotype(genotype) {
  ...
  for (k = 0, len = genotype.length; k < len; k++) {
    allel = genotype[k];
    val = (0, _flexibel.valueof)("inputFor" + allel);
  ...
  return _flexibel.map.values(phenotypeParts).join(", ");
};
...
combineGametes = function combineGametes(g1, g2) {
  ...
  return (0, _flexibel.ejoin)(function () {
    var k, ref, results;
    results = [];
...
onChangeText = function onChangeText() {
  ...
  clearError();
  (0, _flexibel.htmlset)("gametparams", "");

  if (!checkGenotypes((0, _flexibel.valueof)("genotype1"), (0, _flexibel.valueof)("genotype2"))) {
    return;
  }

  gametes = makeGametes((0, _flexibel.valueof)("genotype1"));
  ...
  return (0, _flexibel.htmlset)("gametparams", function () {
    var k, len, results;
    results = [];
...
(0, _flexibel.element)("genotype1").addEventListener("input", onChangeText);
(0, _flexibel.element)("genotype2").addEventListener("input", onChangeText);
(0, _flexibel.element)("runButton").addEventListener("click", runApplication);