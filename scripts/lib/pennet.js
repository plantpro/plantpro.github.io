...
(function () {
  ...
  var Counter, checkGenotype, checkGenotypes, checkedof, clearError, combineGametes, countIt, createOutput, createPhenotypeInput, delws, div, ejoin, element, evalPhenotype, fail, first, htmlset, keys, last, makeGametes, makeKeyCells, makeValueCells, max, maxKey, maxValue, mergeStrings, min, mul, onChangeText, runApplication, sub, sum, valueof, values, valueset;
