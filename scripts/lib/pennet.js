...
(function () {
  ...
  var Counter, checkGenotype, checkGenotypes, checkedof, clearError, combineGametes, countIt, createOutput, createPhenotypeInput, delws, div, ejoin, element, evalPhenotype, fail, first, htmlset, keys, last, makeGametes, makeKeyCells, makeValueCells, _max, maxKey, maxValue, mergeStrings, _min, _mul, onChangeText, runApplication, sub, _sum, valueof, values, valueset;
