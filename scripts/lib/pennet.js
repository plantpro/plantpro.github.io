...
(function () {
  ...
  var Counter, all, any, checkGenotype, checkGenotypes, checkedof, clearError, combineGametes, countIt, createOutput, createPhenotypeInput, delws, div, ejoin, element, evalPhenotype, fail, first, htmlget, htmlset, keys, last, makeGametes, makeKeyCells, makeMapCells, makeValueCells, max, maxKey, maxValue, mergeStrings, min, mul, onChangeText, runApplication, sub, sum, valueof, values, valueset;
